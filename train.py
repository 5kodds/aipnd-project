...
parser.add_argument('--arch', action = 'store', default = 'vgg16', dest = 'arch', type = str)
parser.add_argument('--dropout', action = "store", default = 0.4, dest = 'dropout', type = float)
parser.add_argument('--hidden_units', action = 'store', default = 256, dest = 'hidden_units', type = int)
parser.add_argument('--learning_rate', action = 'store', default = 0.01, dest = 'learning_rate', type = float)
parser.add_argument('--gpu', action = 'store', default = True, dest = 'gpu', type = bool)
...
training_dataloader = torch.utils.data.DataLoader(image_datasets[0], batch_size=64, shuffle=True) 
